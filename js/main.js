...
var portfolio = [{
    ...
    기본에 충실한 기능들을 유지하면서 사용성을 높히려는 욕심에 비해 기획이나 디자인 경험이 부족했던 탓에 예상보다 더 많은 시간이 들기도 했습니다.
    하지만 이는 결과적으로 UI/UX를 고려해 기획을 분석하는 능력을 기를 수 있는 기회가 되었습니다.
    그리고 테스터들의 피드백을 듣고 앱을 수정하는 과정에서 애플에서 제공하는 기술들의 활용도와 SwiftUI에 대한 이해도를 더욱 높힐 수 있었습니다.
