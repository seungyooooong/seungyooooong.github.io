...
var portfolio = [{
    ...
    title: 'Daily - 매일 매일 일정 관리',
    tagList: ['iOS', 'SwiftUI', 'AppStore'],
    form: 'iOS App',
    link: 'https://github.com/TeamND/Daily',
    language: ['Swift'],
    content: `일정 관리 앱 'Daily - 매일 매일 일정 관리'를 만들어 App Store에 출시하고 유지보수 및 관리하고 있습니다.
    ...
    기본에 충실한 기능들을 유지하면서 사용성을 높이려는 욕심에 비해 기획이나 디자인 경험이 부족했던 탓에 예상보다 더 많은 시간이 들기도 했습니다.
    하지만 이는 결과적으로 UI/UX를 고려해 기획을 분석하는 능력을 기를 수 있는 기회가 되었습니다.
    그리고 테스터들의 피드백을 듣고 앱을 수정하는 과정에서 애플에서 제공하는 기술들의 활용도와 SwiftUI에 대한 이해도를 더욱 높일 수 있었습니다.
    또한 직접 스토어에 배포 및 출시를 하면서 개인정보 처리방침이나 앱 소개 이미지 등 프론트 개발 외적인 부분으로도 고려할 부분이 많다는 것을 배웠습니다.
    기획부터 개발 출시까지의 경험은 iOS 개발자로서 기본을 다질 수 있는 좋은 경험이었다고 생각합니다.
    앞으로도 꾸준한 추가 개발과 유지보수를 통해 'Daily' 앱을 발전시키고 iOS 개발자로서 역량을 개발할 것입니다.`
}]
